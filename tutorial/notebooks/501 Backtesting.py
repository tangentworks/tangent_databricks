...
# MAGIC %md
# MAGIC Here, the following situations are outlined:
...
auto_forecast_result = tw.forecasting.auto_forecast(configuration=auto_forecasting_configuration,dataset=tangent_dataframe)
production_forecast_results_table = auto_forecast_result.predictions
production_forecast_properties = tw.insights.properties(model=auto_forecast_result.model.to_dict())
...
auto_forecast_result = tw.forecasting.auto_forecast(configuration=auto_forecasting_configuration,dataset=tangent_dataframe)
production_training_results_table = auto_forecast_result.predictions
production_training_properties = tw.insights.properties(model=auto_forecast_result.model.to_dict())
...
auto_forecast_result = tw.forecasting.auto_forecast(configuration=auto_forecasting_configuration,dataset=tangent_dataframe)
backtest_results_table = auto_forecast_result.predictions
backtest_properties = tw.insights.properties(model=auto_forecast_result.model.to_dict())
...
auto_forecast_result = tw.forecasting.auto_forecast(configuration=auto_forecasting_configuration,dataset=tangent_dataframe)
long_backtest_results_table = auto_forecast_result.predictions
long_backtest_properties = tw.insights.properties(model=auto_forecast_result.model.to_dict())
