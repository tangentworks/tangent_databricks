...
# MAGIC %md
# MAGIC # Tangent Databricks Example - Solar Production Forecasting
...
file_path = '/Workspace'+dbutils.notebook.entry_point.getDbutils().notebook().getContext().notebookPath().get().rsplit('/', 2)[0]+'/data/solar_single_asset.csv'
tangent_dataframe = pd.read_csv(file_path)
group_keys = []
timestamp_column = "timestamp"
target_column = "PV_obs"
